...
export default function CustomerDashboard() {
    ...
    const filteredTickets = statusFilter
        ? statusFilter === 'IN_PROGRESS'
            ? tickets.filter((ticket) => ticket.status === 'IN_PROGRESS' || ticket.status === 'OPEN') // Include OPEN for backward comp
    ...
    const stats = {
        ...
        in_progress: tickets.filter((t) => t.status === 'IN_PROGRESS' || t.status === 'OPEN').length, // Group old OPEN with IN_PROGRESS
