                                    ...
                                    <tr key={contact.id} className="hover:bg-gray-50 transition">
                                        <td className="px-2 py-4">
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                {contact.sync_source === 'intratime' && (
                                                    <span className="flex-shrink-0 inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-700" title="Sincronizado desde Intratime">Sync</span>
                                                )}
                                                {contact.sync_source === 'import' && (
                                                    <span className="flex-shrink-0 inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-700" title="Importado desde Excel">Import</span>
                                                )}
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-2 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <Link
                                                ...
                                                className="text-gray-500 hover:text-primary-600 mr-4 inline-flex items-center gap-1 transition-colors"
                                                title="Ver ficha 360°"
                                            >
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                                        ...
                                        {editingContact?.sync_source && (
                                            <span className="ml-2 text-xs font-normal text-gray-400">(campo gestionado por {editingContact.sync_source === 'intratime' ? 'Intratime' : 'importación'})</span>
                                        )}
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        className={`w-full px-4 py-2 border border-gray-300 rounded-lg ${editingContact?.sync_source ? 'bg-gray-50 cursor-not-allowed' : 'focus:ring-2 focus:ring-primary-500'}`}
                                    />
                                </div>
                                <div>
